...
raw_model_nc_w = load_model("data/processed/models/current_climate_xgboost_no_cbsa_with_weights.pkl")
...
for year in YEARS:
    ...
    X = prepare_cat_cols(raw_pd, CAT_COLS_NO_CBSA)[get_feature_names(cal_model_nc_w)]

    pred_probs_w = cal_model_nc_w.predict_proba(X)[:, 1]
